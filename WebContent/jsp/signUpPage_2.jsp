...
<div id="all">
    ...
    <ul class="nav nav-tabs">
      ...
      <li><a data-toggle="tab" href="#hostSignUp" id = "selectedMM">플리마켓 주최</a></li>
   </ul>
   ...
   <div id="signUpContentDiv">
      ...
      <div id='content' class="tab-content">
         ...
         <input type="hidden" name="registerCode" value="register"/>      
            <div class="row">
...
②2014년 3월 17일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
                  ...
                  <br>
                  <input type="checkbox" name="policy" value="policy" id = "muPolicyCheck"> 약관 동의
                  <br>
         ...
         </div><!-- end of #attendantSignUp -->
             
         <div class="tab-pane fade" id="hostSignUp">
         <!-- ajax비동기 처리 -->
            ...
            <div class="row">
               ...
               <div class="col-md-4">
               		<div id="mmExistNicknameResult"></div> 
                  <input type="text" class="form-control" placeholder="닉네임 입력" size="20" name="mmNickname" id="mmNicknameForm">
                  <input type="email" class="form-control" placeholder="연락 이메일 입력" size="20" name = "contactEmail" id = "mmContactEmailForm">
                    <input type="text" class="form-control" placeholder="주민번호  앞 7자리 입력"  size="20" name = "mmBirth" id = "mmBirthForm" maxlength = 7>
                      <div id = "mmBResultForm"></div>
                  <br>
               </div>
               <div class="col-md-4">
                  <input type="text" class="form-control" placeholder="주최자 이름" size="20" name = "mrgName" id = "mrgNameForm">
                  <input type="text" class="form-control" placeholder="주최" size="20" name = "organization" id = "organizationForm"> 
                   <input type="text" class="form-control" placeholder="사업자 번호" size="20" name = "marketMrgNo" id = "mmMarketMrgNoForm">
                  <br>
               </div>
...
②2014년 3월 17일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
                  ...
                  <br>
                  <input type="checkbox" name="policy" value="policy" id = "mmPolicyCheck"> 약관 동의
                  <br>
                 <button type="button" id="signUpBtn2" class="btn btn-success">회원가입</button>
               </div>
               <div class="col-md-3"></div>
            </div> <!-- end of .row -->
      
         </div><!-- end of hostSignUp -->
    
      </div><!-- end of .tab-content -->
             </form>
      <!--  </div>--> <!-- end of row -->
   </div> <!-- end of signUpContent -->
